<template>
    <div class="container bg-white animate__animated animate__fadeIn">
        <section class="pt-7">
            <div class="container bg-white">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-end"><img class="pt-7 pt-md-0 img-fluid" src="@icons/icon-mingle.png"
                            alt="" /></div>
                </div>
            </div>
        </section>
        ...
        <section class="pt-5 pt-md-9 mb-6" id="feature">
            ...
            <div class="container">
                <h1 class=" fw-bold mb-4 text-center"> We design tools to unveil <br class="d-none d-xl-block" />your
                    superpowers</h1>
                <div class="row">
                    <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="@icons/icon-mingle.png"
        ...
        <section class="pt-5" id="validation">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6"><img class="img-fluid" src="@icons/icon-mingle.png" alt="" />
                    </div>
                </div>
            </div><!-- end of .container-->
        ...
        <section class="pt-5" id="manager">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6"><img class="img-fluid" src="@icons/icon-mingle.png" alt="" /></div>
                    <div class="col-lg-6">
                        ...
                        <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2"
                                src="@icons/icon-mingle.png" width="35" alt="tick" />
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        <div class="card"><img class="card-img-top" src="@icons/icon-mingle.png" alt="" />
